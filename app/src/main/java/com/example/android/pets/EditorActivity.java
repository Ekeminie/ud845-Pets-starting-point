...
public class EditorActivity extends AppCompatActivity implements android.app.LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // has touched or modified them. This will let us konw if there are unsaved changes
        // or not, if the  user tries to leae the editor without saving.
...
//                NavUtils.navigateUpFromSameTask(this);
    ...
    private void savePet() {
       ...
       /*int weight = 0;
        ...
        values.put(COLUMN_PET_WEIGHT, weightString);
