...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       FloatingActionButton fB = findViewById(R.id.fab1);
        fB.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Intent intent = new Intent (CatalogActivity.this, AllActivity.class);
                startActivity(intent);
            }
        });
...
//        displayDatabaseInfo();
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle){
        ...
        return new CursorLoader(this,   // Parent activity context
                ...
                COLUMN_PET_GENDER + "=?",           // No selection clause
                sel,           // No selection arguments
...
//        SQLiteDatabase db = mDbHelper.getWritableDatabase();
        ...
        values.put(COLUMN_PET_GENDER, PetEntry.GENDER_FEMALE);
